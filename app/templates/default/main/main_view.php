<div class="inner cover" style="margin-top: 120px;width: 1000px;margin-left: auto;margin-right: auto;">
			...
			<div class="tab-content" style="width: 67%; float: left; margin-left: 70px;">
				...
				<div class="tab-pane active" id="executor">
					<p class="lead" style="height: auto; ">
  ...
  list-style: circle;">
            ...
            <p class="lead">
              <a href="/katalog/" class="btn btn-lg btn-default orange-back" style="margin-left: 190px;">Перейти к сервису</a>
            </p>
		</div>